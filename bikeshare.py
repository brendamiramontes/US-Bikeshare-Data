...
def get_filters():
    ...
    # Get user input for city - new comment for git documentation branch
    while True:
    ...
    # Get user input for month - new comment for git documentation branch 
    ...
    # Get user input for day of week - new comment for refactoring branch
